...
SESSION_PREFIX="${SESSION_PREFIX:-followup6}"
DRY_RUN="${DRY_RUN:-0}"
...
JOBS=(
  "0|3s5z|iql_attnres_l2|3|"
  "0|3s5z|vdn_attnres_l2|3|"
  "0|3s5z|qmix|5|"
  "0|3s5z|qmix_depth_mlp|5|"
  ...
  "6|3s5z|qmix|4|"
  "6|3s5z|qmix_depth_mlp|4|"
)

manifest="$RESULTS_DIR/run_manifests/${SESSION_PREFIX}_6gpu_$(date +%Y%m%d_%H%M%S).tsv"
...
echo "  tail -f $RESULTS_DIR/launcher_logs/3s5z_iql_attnres_l2_s3_gpu0.log"
echo
...
echo "  python scripts/plot_marl_transfer_curves.py --sacred-dir results/sacred --output-dir paper/latex/figures"
echo "  python scripts/plot_attn_weight_heatmaps.py --sacred-dir results/sacred --output-dir paper/latex/figures --configs qmix_attnres_l2"
