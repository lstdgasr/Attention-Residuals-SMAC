...
RUN_TAG="${RUN_TAG:-hardmix_$(date +%Y%m%d_%H%M%S)}"
...
JOBS=(
  ...
  "2|8m_vs_9m|qmix_attnres_l2|1|record_attn_weights=True"
  "2|MMM2|qmix_attnres_l2|1|record_attn_weights=True"

  "3|5m_vs_6m|qmix_attnres_l2|5|record_attn_weights=True"
  "3|8m_vs_9m|qmix_attnres_l2|2|record_attn_weights=True"
  "3|MMM2|qmix_attnres_l2|2|record_attn_weights=True"

  "4|5m_vs_6m|qmix_depth_mlp|4|"
  "4|8m_vs_9m|qmix_depth_mlp|1|"
  "4|MMM2|qmix_depth_mlp|1|"

  "5|5m_vs_6m|qmix_depth_mlp|5|"
  "5|8m_vs_9m|qmix_depth_mlp|2|"
  "5|MMM2|qmix_depth_mlp|2|"

  "6|3s5z_vs_3s6z|qmix|1|"
  "6|3s5z_vs_3s6z|qmix_attnres_l2|1|record_attn_weights=True"
  "6|3s5z_vs_3s6z|qmix_depth_mlp|1|"

  "7|3s5z_vs_3s6z|qmix|2|"
  "7|3s5z_vs_3s6z|qmix_attnres_l2|2|record_attn_weights=True"
  "7|3s5z_vs_3s6z|qmix_depth_mlp|2|"
)
...
echo
echo "Launched hardmix 8GPU queues."
echo "Monitor with:"
echo "  tmux ls"
echo "  watch -n 5 nvidia-smi"
echo "  tail -f $RESULTS_DIR/launcher_logs/${RUN_TAG}_5m_vs_6m_qmix_attnres_l2_s4_gpu2.log"
echo
echo "After all queues finish, summarize and plot with:"
echo "  python scripts/summarize_marl_transfer_adaptation.py --sacred-dir \"$RESULTS_DIR/sacred\" --output-dir \"$RESULTS_DIR/diagnostics\" --maps 5m_vs_6m,8m_vs_9m,3s5z_vs_3s6z,MMM2"
echo "  python scripts/plot_marl_transfer_curves.py --sacred-dir \"$RESULTS_DIR/sacred\" --output-dir \"$RESULTS_DIR/figures\" --maps 5m_vs_6m,8m_vs_9m,3s5z_vs_3s6z,MMM2"
